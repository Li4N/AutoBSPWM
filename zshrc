...
alias enum4linux='python3 /usr/bin/enum4linux-ng.py'
alias cat='batcat'
alias vol3='docker run -v $PWD:/workspace sk4la/volatility3'
alias catn='/usr/bin/cat'
alias catl='batcat -l ruby'
alias pyServer='python -m http.server 4444'
alias stego='sudo docker run -it --rm -v $(pwd)/data:/data dominicbreuker/stego-toolkit /bin/bash'
alias clearh='history -p'
alias clearzsh='echo "" > ~/.zsh_history;zsh'
alias cme=crackmapexec
alias mobsf='sudo docker run -it --rm -p 8000:8000 mobsf'
...
# Functions
function mkt(){
	mkdir {nmap,content,exploits,flags,scripts}
}
...
# Set target ip to see it at polybar
